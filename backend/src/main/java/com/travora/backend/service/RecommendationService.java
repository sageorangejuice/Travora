...
public class RecommendationService {
    ...
    public List<Dining> getTopDining() {
        return scoringStrategy.rank(diningRepository.findTop20ByOrderByRatingDesc());
    }

    public List<Activity> getTopActivities() {
        return scoringStrategy.rank(activityRepository.findTop20ByOrderByRatingDesc());
    }
